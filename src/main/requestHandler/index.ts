...
import getUserProfile from "./requestHelper/getUserProfile";
...
import shareReferralCode from "./requestHelper/shareReferralCode";
...
async function requestHandler(
    ...
    try {
        switch (reqEventName) {
            ...
            case EVENTS.SHARE_REFERRAL_CODE: //SHARE_REFERRAL_CODE
                shareReferralCode(data, socket, ack);
                break; 
                
            case EVENTS.GET_USER_PROFILE: //SHARE_USER_PROFILE
               getUserProfile(data.data, socket, ack);
                break;
