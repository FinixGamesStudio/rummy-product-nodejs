...
export async function poolRummyLeaveRoundTable(
    ...
    try {
        ...
        if (playerData.isWaitingForRejoinPlayer) {
            ...
            logger.info("----->> poolRummyLeaveRoundTable :::: 1 :::: roundTableData ::", roundTableData);
            logger.info("----->> poolRummyLeaveRoundTable :::: 1 :::: playerData ::", playerData);
        ...
        if (
            ...
            if (playerLeave && flag) {
                ...
                logger.info("----->> poolRummyLeaveRoundTable :::: 2 :::: roundTableData ::", roundTableData);
                logger.info("----->> poolRummyLeaveRoundTable :::: 2 :::: playerData ::", playerData);
                ...
                commonEventEmitter.emit(EVENTS.SHOW_POP_SOCKET_EVENT, {
                  ...
                  logger.info(
                    " ------>> ------>> poolRummyLeaveRoundTable  :: findUser ::>> ",
                    findUser
                  );
                  if (!findUser) {
                 ...
                 logger.info(" poolRummyLeaveRoundTable :: updatedUser :: ==>> ", updatedUser);
