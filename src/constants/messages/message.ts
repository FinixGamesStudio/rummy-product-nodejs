export = Object.freeze({
    ...
    OTHER_PLAYER_DECLARING_MESSAGE: `Wait for opponent player to declare in 0 seconds`,
    ...
    REJOIN_GAME_CASH_POPUP_MIDDLE_MESSAGE: `Your current cash balance: ₹`,
    REJOIN_GAME_COINS_POPUP_MIDDLE_MESSAGE: `Your current coins balance: ₹`,
