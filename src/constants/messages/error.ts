export = Object.freeze({
    ...
    JOIN_SAME_TABLE_TO_LINK: 'You are joined to the same table',
    PRIVATE_TABLE_TIMER_EXPIRE : " Sorry Your Private_Table Is Expire....",
    PRIVATE_TABLE_IS_CLOSE : " Your table and code validity are over.",
    PRIVATE_TABLE_FULL: ' Sorry This Table Is Full !!! ',
    CODE_ERROR: 'Your Code is wrong. Please try again later.',
    USER_NOT_FOUND: 'Sorry User Is Not Found. Please Register Now.',
    NOT_ENOUGH_BALANCE: 'Sorry User balace is not enough. Please check your balance and try again',
    MSG_ERROR:"error"
})